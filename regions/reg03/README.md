...
This folder is the region-default content layer for `reg03`.
...
- `regions/reg03/data/primary-assets.json`
- `regions/reg03/data/primary.json`
- `regions/reg03/data/footer.json`
- `regions/reg03/data/primaryending.json`
- `regions/reg03/assets/primary/manifest.json`
- `regions/reg03/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg03`.
